defmodule BotArmyMemory.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Memory Bot.
  ...
  2. **`bot.memory.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "memory"
  @envelope_source "bot_army_memory"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Memory Bot pulse publisher")
