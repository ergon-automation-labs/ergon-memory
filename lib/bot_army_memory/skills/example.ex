defmodule BotArmyMemory.Skills.Example do
  @moduledoc """
  Example skill for Memory Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_memory.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_memory.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_memory/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_memory.command.example"
    ]
  end
